...
GENERO: da un conteo del genero (femenino = 1 y masculino = 0) de cada sujeto de la poblacion muestral.
...
1. los hombres tienen tendencia a invertir mayor cantidad de tiempo y dinero en videojuegos con respecto a las mujeres.
2. las mujeres prefieren en mayor medida jugar en dispositivos android por la versatilidad, que en dispositivos windows.
